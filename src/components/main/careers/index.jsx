    ...
    <div className="flex mb-0 flex-wrap">
      ...
      <div className="w-full md:w-1/2 lg:w-1/2 text-white text-left mt-12 p-20 mr-50 text-4xl">
        <p>
          ...
          this is your time. We&apos;re looking for the curious, the bold, and the brilliant. So, if you&apos;re ready
          to push the boundaries of what&apos;s possible, come join us and together, we&apos;ll redefine the future of
