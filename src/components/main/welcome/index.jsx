            ...
            <div className="px-[100px] py-[150px] flex bg-cover bg-center bg-[url('/assets/images/welcome/bg_1.svg')] flex-col w-full">
                <div className="text-white text-title">
                    ...
                    <div className="flex flex-wrap justify-between items-center">
                        <div className="text-title-lg text-white">
                            We Re-imagine
                        </div>
            ...
            <div className="bg-[#111111] text-white p-[30px]">
                {
                    bullets.map((aBullet, idx) => (
                        <div key={idx} className="flex flex-wrap pb-[100px]">
                            ...
                            <div >
                                <div className="link link--metis text-sm">
                                    Learn more
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex gap-[10px]">
                            <div className="text-[19px] text-white w-full border border-white rounded-md p-[15px]">
                                ...
                                <div className="flex justify-end w-full p-[10px] pt-[30px]">
                                    <Image width={50} height={50} alt="graphic" src={'/assets/images/welcome/graphic/interruption.svg'} />
                                </div>
                            </div>
                            <div className="text-[19px] text-white w-full border border-white rounded-md p-[15px]">
                                <div className="h-[70px]">
                                ...
                                <div className="flex justify-end w-full p-[10px] pt-[30px]">
                                    <Image width={50} height={50} alt="graphic" src={'/assets/images/welcome/graphic/energy.svg'} />
                                </div>
                            </div>
                            <div className="text-[19px] text-white w-full border border-white rounded-md p-[15px]">
                                <div className="h-[70px]">
                                ...
                                <div className="flex justify-end w-full p-[10px] pt-[30px]">
                                    <Image width={50} height={50} alt="graphic" src={'/assets/images/welcome/graphic/unlimited.svg'} />
                                </div>
                            </div>
                        </div>
                    </div>
