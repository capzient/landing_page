export const bullets = [
  {
    title_1: 'Visionary',
    title_2: 'Innovation',
    description: 'Say goodbye to range anxiety',
  },
  {
    title_1: 'Unmatched ',
    title_2: 'Expertise',
    description: 'Keeping systems operational everywhere, in all conditions.',
  },
  {
    title_1: 'Seamless',
    title_2: 'User Experience',
    description: 'Sustainable and reliable power for off-grid locations.',
  },
  {
    title_1: 'Commitment to',
    title_2: 'Excellence',
    description: 'Fuel-Store-Generate power on-site anywhere, eliminating transport and emissions.',
  },
];
