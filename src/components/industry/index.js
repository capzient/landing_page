            ...
            <div className="bg-[#1A1A1A] p-[80px] flex h-full flex-col justify-between text-white text-[50px] gap-[20px] w-full rounded-lg">
              <div className="flex flex-col gap-[20px]">
                ...
                <div className="text-[#B3B3B2] text-[20px]">
                  Lorem ipsum dolor sit amet consectetur. Sapien ut sit molestie
                  dui nunc.
                </div>
              </div>
          ...
          <div className="pr-[10px] w-[50%]">
            <div className="bg-[#1A1A1A] p-[80px] flex h-full flex-col justify-between text-white text-[50px] gap-[20px] w-full rounded-lg">
              <div className="flex flex-col gap-[20px]">
                ...
                <div className="text-[#B3B3B2] text-[20px]">
                  Expert managed services drive stability, optimization and
                  transformation in complex cloud-based IT environments.
                </div>
              </div>
              <div className="flex justify-end">
                <div className="text-[#F9EFEC]  text-right text-[30px]">
        ...
        <div className="flex">
          ...
          <div className="w-[55%] bg-[#1A1A1A] rounded-lg p-[60px]">
            <div className="flex justify-between border-[#262626] border-b-[1px] pb-[20px]">
              ...
              <Image
                src={"/assets/images/industry/button_1.svg"}
                width={40}
                height={40}
                alt=""
              />
            ...
            <div className="w-full  pt-[20px]">
              <Image
                src={"/assets/images/industry/image.svg"}
                layout="responsive"
                width={100}
                height={100}
                alt=""
